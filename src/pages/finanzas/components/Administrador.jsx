...
const Administrador = () => {
    return (
        <div className="min-h-[calc(100vh-64px)] bg-[#050505] text-white p-4 md:p-8 animate-in fade-in duration-500 overflow-y-auto scrollbar-hide w-full">
            ...
            <div>
                <h2 className="text-2xl font-bold text-white">Configuración del Módulo</h2>
                <p className="text-gray-400 text-sm mt-1">Administra cuentas, bancos y permisos financieros.</p>
            </div>
            ...
            <div className="bg-[#111520] border border-white/5 rounded-2xl p-10 text-center flex flex-col items-center justify-center min-h-[400px] shadow-xl">
                ...
                <p className="text-gray-500 max-w-md">Pronto podrás configurar cuentas bancarias, pasarelas de pago y reglas automáticas.</p>
            </div>
            </div>
        </div>
    );
